...
if id_number:
    try:
        ...
        if not match.empty:
            ...
            if first_collection == 500 and second_collection == 500:
                first_enabled = False
                second_enabled = False
...
with st.form("collection_form"):
    ...
    # First Collection
    if first_enabled:
        updated_first = st.selectbox("First Collection", [0, 500],
    ...
    # Second Collection
    if second_enabled:
        updated_second = st.selectbox("Second Collection", [0, 500],
